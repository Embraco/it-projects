...
function exportToSheets(filter){
  ...
  var titles = ['REQUEST ID', 'STATUS', 'CURRENTLY WITH', 'START DATE', 'REQUESTER', 'LOCAL AREA MANAGER', 'TITLE', 'DEPARTMENT', 'PLANT', 'LAST UPDATE', 'LOCAL AREA MANAGER APPROVAL', 'LOCAL IT MANAGER', 'LOCAL IT MANAGER APPROVAL', 'BRM', 'BRM SEND', 'IT PROJECT LEADER ANALYSIS', 'IT PROJECT LEADER ANALYSIS SEND', 'IT PORTFOLIO MANAGER', 'IT PORTFOLIO MANAGER APPROVAL', 'PROJECT MANAGER', 'SPONSOR', 'EVALUATION'];
